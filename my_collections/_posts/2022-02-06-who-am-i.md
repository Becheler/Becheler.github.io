...
Often I don't know some details of these models with precision and so I try to estimate them in a Bayesian framework. When working with complex landscapes, it's not possible to compute a likelihood, so I use simulation-based inference instead.
...
*Ahlala*, coalescence: the nightmare of every grad student. It too me a PhD and countless sleepless nights to understand maybe 1% of this theory.
...
## My mission, should I choose to accept it: make this inference framework 
