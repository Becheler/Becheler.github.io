...
Inevitably, later or sooner the user would have to build its own modeling functions\+: all we can do is to propose {\bfseries{concise way to express them.}}\hypertarget{group__expressive_autotoc_md7}{}\doxyparagraph{ \+Favor code modularity.}\label{group__expressive_autotoc_md7}
