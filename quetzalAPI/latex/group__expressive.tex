...
\hypertarget{group__expressive_autotoc_md6}{}\doxysubsubsection{Motivations}\label{group__expressive_autotoc_md6}
\DoxyHorRuler{0}
\hypertarget{group__expressive_autotoc_md7}{}\doxyparagraph{Better express user-\/defined mathematical models}\label{group__expressive_autotoc_md7}
...
Inevitably, later or sooner the user would have to build its own modeling functions\+: all we can do is to propose {\bfseries{concise way to express them.}}\hypertarget{group__expressive_autotoc_md8}{}\doxyparagraph{ \+Favor code modularity.}\label{group__expressive_autotoc_md8}
...
Expressive features allow to {\bfseries{encapsulate models details in an efficient way.}}\hypertarget{group__expressive_autotoc_md9}{}\doxyparagraph{Do it with minimal runtime cost}\label{group__expressive_autotoc_md9}
...
\end{DoxyItemize}\hypertarget{group__expressive_autotoc_md10}{}\doxysubsubsection{Examples of biological interests}\label{group__expressive_autotoc_md10}
\DoxyHorRuler{0}
\hypertarget{group__expressive_autotoc_md11}{}\doxyparagraph{Representing dispersal kernels}\label{group__expressive_autotoc_md11}
...
\end{DoxyCode}
\hypertarget{group__expressive_autotoc_md12}{}\doxyparagraph{Representing environmental quantities as functions of space and time.}\label{group__expressive_autotoc_md12}
