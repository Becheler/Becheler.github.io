...
These classes are useful for defining stochastic processes that enable coalescence simulation of a sample.\hypertarget{group__simulator_autotoc_md13}{}\doxysubsubsection{C++ concept \+: Generative\+Model}\label{group__simulator_autotoc_md13}
